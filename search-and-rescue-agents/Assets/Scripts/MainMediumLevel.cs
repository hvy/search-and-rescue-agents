 ...
 */
public class MainMediumLevel : MonoBehaviour {
	...
	void Start () {
		...
		entrances.Add (new Vector2(21.0f, 0.3f));
		entrances.Add (new Vector2(22.0f, 0.3f));
		entrances.Add (new Vector2(23.0f, 0.3f));
		entrances.Add (new Vector2(24.0f, 0.3f));
